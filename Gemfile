...
gem "sassc-rails"
gem "rails", ">= 7.1.0", (ENV["RAILS_VERSION"] || ">= 4.0.0") # rubocop:disable Bundler/OrderedGems
gem "rspec-rails", ">= 6.0.0", (ENV["RAILS_VERSION"].nil? || ENV["RAILS_VERSION"].to_s >= "6.0.0" ? "4.0.0.beta2" : ">= 3.8.0")
gem "sqlite3",
