...
gem "activerecord-jdbcsqlite3-adapter", ">= 60.0", jruby_sqlite3_adapter, platform: :jruby
gem "byebug", platforms: %i[mri mingw x64_mingw]
gem "capybara", "< 3.19.0" unless ENV["TRAVIS_RUBY_VERSION"].nil? || ENV["TRAVIS_RUBY_VERSION"] >= "2.4.0"
gem "sassc-rails"
gem "rails", ">= 6.0.5.1", (ENV["RAILS_VERSION"] || ">= 4.0.0") # rubocop:disable Bundler/OrderedGems
